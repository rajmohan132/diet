...
Route::match(['get', 'post'], 'reports/paid_report',[ReportController::class, 'paid_report']);
Route::match(['get', 'post'], 'reports/pending_report',[ReportController::class, 'pending_report']);
Route::match(['get', 'post'], 'reports/sales_Report',[ReportController::class, 'sales_Report']);
Route::match(['get', 'post'], 'reports/subcrption_report',[ReportController::class, 'subcrption_report']);
Route::match(['get', 'post'], 'reports/customplan_report',[ReportController::class, 'customplan_report']);
Route::match(['get', 'post'], 'reports/normalplan_report',[ReportController::class, 'normalplan_report']);
Route::match(['get', 'post'], 'reports/cancled_Report',[ReportController::class, 'cancled_Report']);
Route::match(['get', 'post'], 'reports/unpaid_report',[ReportController::class, 'unpaid_report']);
...
Route::match(['get', 'post'], 'reports/expiring_Report',[ReportController::class, 'expiring_Report']);
Route::match(['get', 'post'], 'reports/expired_report',[ReportController::class, 'expired_report']);

               ...
               <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title">SubPlan Updation</h4>
                     </div>
                  </div>
                  <div class="card-body">
                    
                     <form class="row g-3 needs-validation" novalidate action="{{ route('subplan-update') }}" enctype="multipart/form-data" method="POST">
                     @csrf
                     <input type="hidden" name="subplanid" value="{{$subplan->id}}" >
                     <div class="col-md-12">
                           <label for="validationCustom01" class="form-label">Sub Plan Code</label>
                           <input value="{{$subplan->subplancode}}" type="text" class="form-control" id="validationCustom01" required name="subplancode">
                        ...
                        <div class="col-md-12">
                           ...
                           <input value="{{$subplan->splanname}}" type="text" class="form-control" id="validationCustom02" required name="splanname">
                           <div class="invalid-feedback">
                        ...
                        @foreach($plan as $plans)
                              ...
                              <option value="{{$plans->id}}" @if($subplan->planname == $plans->id){{"selected"}} @endif >
                              {{$plans->planname}}
                              </option>
                              @endforeach
                           </select>
                        ...
                        <div class="col-md-12">
                           ...
                           <input type="text" value="{{$plans->price}}" class="form-control" id="validationCustom02" required name="price">
                           <div class="invalid-feedback">
                              Please Enter price
                           </div>
                        </div>
...
<!-- 
                        ...
                        <div class="col-md-12">
                           ...
                           <select class="form-select" id="validationCustom04" required name="status">
                              ...
                              <option value="0" @if($subplan->status == "0") {{"selected"}} @endif > In Active</option>
                              <option value="1" @if($subplan->status == "1") {{"selected"}} @endif >Active</option>

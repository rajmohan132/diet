            ...
            <form action="" method="post">
               ...
               <div class="row" style="padding-left: 29px;">
                  ...
                  <div class="col-2">
                     ...
                     <a href="{{route('normalplan_report')}}"><button type="button" class="btn btn-primary rounded">Reset</button><a>
...
@endif  
                           ...
                           @if($dta->status == 1)
                                        <span class="badge bg-primary">Active</button>
...
@endif  
                               ...
                               @if($dta->paymentstatus == 1)
                                        <span class="badge bg-dark">paid</button>
...
@endif  
                  ...
                  <span class="badge bg-success" style="float: right;padding-top:7px;">Total Sales: {{$sum}} QAR</span>

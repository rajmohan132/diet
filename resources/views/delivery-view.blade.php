    ...
    <div class="row">
      ...
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="col-4">
            <input type="date" id="date_from_delivery_view" class="form-control" placeholder="First name">

            </div>

            <div class="col-4">
            <input type="date" id="date_to_delivery_view" class="form-control" placeholder="First name">

            </div>
            
          
            <div class="col-2">
            <button onclick="date_filter_delivery_view()"  class="btn btn-primary rounded">Search</button>

            </div>

            
</div>
            <div id="filter_delivery_view"></div>
            <div class="card-body">
             <div class="table-responsive">
                  <table id="datatable" class="table table-striped nofilter_delivery_view" data-toggle="data-table">
                     <thead>
                        <tr>
...
<script>
function date_filter_delivery_view(){
   var fromDate = $("#date_from_delivery_view").val();
   var toDate = $("#date_to_delivery_view").val();

   $.ajax({
            url:"{{route('filter_order_by_date_delivery_view')}}",
            method:'POST',
            data:{fromdate:fromDate,todate:toDate, "_token":"{{csrf_token()}}" },
            //dataType:'JSON',
            success:function(res){
               $(".nofilter_delivery_view").hide();
               console.log(res);
               $("#filter_delivery_view").html(res);

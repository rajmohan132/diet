        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
          <div class="container-fluid navbar-inner">
            <a href="index.html" class="navbar-brand">
              <!--Logo start-->
              <div class="logo">
               <img src="https://artisans.qa/dietapp/public/assets/images/favicon.png" class="img-fluid logo-img" alt="img4">
              </div>
            ...
            <a class="nav-link "  href="javascript:void(0);">
                <i class="las la-moon" id="darkModeIcon"  class="darkModeIcon"></i>
                  ...
                  <div class="sub-drop dropdown-menu dropdown-menu-end p-0" aria-labelledby="notification-drop">
                    <div class="card shadow-none m-0">
                      ...
                      <div class="card-body p-0">
                        ...
                        <a href="#" class="iq-sub-card">
                          <div class="d-flex align-items-center">
                            <img class="avatar-40 rounded-pill" src=" {{ asset('assets/images/layouts/03.png') }}" alt="">
                            <div class="ms-3 w-100">
                    ...
                    <div class="card shadow-none m-0">
                      ...
                      <div class="card-body p-0 ">
                        <a href="#" class="iq-sub-card">
                          <div class="d-flex  align-items-center">
                            <div class="">
                              <img class="avatar-40 rounded-pill" src="{{ asset('assets/images/layouts/01.png') }}" alt="">
                            </div>
                            <div class="ms-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li>
                      <a class="dropdown-item" href="{{url('profile_settings')}}">Profile</a>
                    </li>
                    
                    <li>
                      <a class="dropdown-item" href="{{route('lock_site')}}">Lock Screen</a>
                    </li>
                    ...
                    <li>
                      <a class="dropdown-item"  onclick="logout()"> {{ __('Logout') }}</a>
                    </li>
